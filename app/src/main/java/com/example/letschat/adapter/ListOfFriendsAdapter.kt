...
import com.example.letschat.SampleData

// This adapter class is responsible for communication between two different interfaces in this case the interfaces were (SampleData & RecyclerView) which ensured the replication of a particular user interface multiple times.
